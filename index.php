                ...
                <div class="col-md-12">
                    <div class="block wow fadeInUp" data-wow-duration="500ms" data-wow-delay="300ms">
                        ...
                        <div id="owl-example" class="owl-carousel">
                            <div>
                                <img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/images/slider/slider-img-1.jpg" alt="">
                            </div>
                            <div>
                                <img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/images/slider/slider-img-2.jpg" alt="">
                            </div>
                            <div>
                                <img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/images/slider/slider-img-3.jpg" alt="">
                            </div>
                            <div>
                                <img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/images/slider/slider-img-4.jpg" alt="">
                            </div>
                            <div>
                                <img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/images/slider/slider-img-1.jpg" alt="">
                            </div>
